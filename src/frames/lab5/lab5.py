...
from src.frames.lab5.tasks.task1 import Task1Frame
from src.frames.lab5.tasks.task2 import Task2Frame
from src.frames.lab5.tasks.task3 import Task3Frame
from src.frames.lab5.tasks.task4 import Task4Frame
