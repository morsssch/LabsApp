...
class Task4Frame(ctk.CTkFrame):
    def __init__(self, master, **kwargs):
        ...
        self.label = ctk.CTkLabel(
            self,
            text="Задание 4: Возведение элементов чётных столбцов в квадрат",
        ...
        self.square_button = buttonComponent(
            self.button_frame,
            text="Возвести в квадрат чётные столбцы",
            command=self.square_even_columns,
        )
